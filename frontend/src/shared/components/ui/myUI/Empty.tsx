...
export default function Empty({
  ...
  return (
    <div className="m-auto flex h-full w-full shrink flex-col bg-contain bg-no-repeat">
      <motion.h1
        variants={container}
        initial="initial"
        animate="animate"
      ...
      <p
        className={cn(
          "text-center font-bold text-2xl sm:text-2xl md:text-[30px] lg:text-[50px] dark:text-blue-500/50 text-amber-300",
          desClassName,
        )}
      >
        {message}
